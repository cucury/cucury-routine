<template >
  <div class='relative flex w-full'>
    <CucuryDDayCategoryEditHeader
      :label='getDDayTextByCouple({ howManyDay })'
    ...
    <div class='absolute top-32 bg-white w-full rounded-tl-2xl rounded-tr-2xl p-6 h-[calc(100vh_-_18rem)] z-30' >
      <div class='flex flex-col h-full gap-4'>
        <div class='font-bold text-red-500'>커플</div>
        <input type='text' value='❤️' v-model="name">
...
import { getDDayTextByCouple } from '@/service/dday'
import { DDay } from '@/models/DDay'
export default {
  name: 'CucuryDDayCouple',
